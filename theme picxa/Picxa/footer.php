...
<footer class="footer">
  ...
  <div class="container footer-bot">
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/footer-logo.png" alt="Picxa" title="Picxa"/>
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.nicescroll.min.js" type="text/javascript"></script>
