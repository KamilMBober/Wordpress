...
class Walker_Nav_Links extends Walker_Nav_Menu{
	...
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0){
		...
		$class_name = join(' ', apply_filters('tm-footer-link',array_filter($classes), $item, $args) );
		...
		$item_output .= '<a  '.$attributes.' class="tm-text-link"  >';
